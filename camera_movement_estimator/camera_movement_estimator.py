...
class CameraMovementEstimator():
    def __init__(self,frame):
        ...
        first_frame_greyscale=cv2.cvtColor(frame,cv2.COLOR_RGB2GRAY)
        ...
        for object,object_tracks in tracks.items():
            for frame_num,track in enumerate(object_tracks):
                for tracks_id,track_info in tracks.items():
                    ...
                    tracks[object][frame_num][tracks_id]['position_adjusted']=position_adjusted
    ...
    def get_camera_movement(self,frames,read_from_stub=False,stub_path=None):
        ...
        for frame_num in range(1,len(frames)):
            ...
            new_features,_,_=cv2.calcOpticalFlowPyrLK(old_grey,frame_gray,old_features,None,**self.lk_params)
