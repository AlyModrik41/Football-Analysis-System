            ...
            for object, object_tracks in tracks.items():
                ...
                for track_id, track_info in object_tracks[frame_num].items():
                    if 'speed' in track_info:
                        ...
                        cv2.putText(frame,f"{speed:.2f} km/h", position,cv2.FONT_HERSHEY_COMPLEX_SMALL,0.5,(0,0,0),2)
                        cv2.putText(frame,f"{distance:.2f} m", (position[0],position[1]+20),cv2.FONT_HERSHEY_COMPLEX_SMALL,0.5,(0,0,0),2)
